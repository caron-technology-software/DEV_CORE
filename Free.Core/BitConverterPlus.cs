...
namespace Free.Core
{
    ...
    public static class BitConverterPlus
    {
        ...
        static unsafe bool GetIsDoubleLittleEndian()
        {
            ...
            if (b[7] == 0x3F && b[6] == 0xF0 && b[5] == 0 && b[4] == 0 && b[3] == 0 && b[2] == 0 && b[1] == 0 && b[0] == 0)
            {
                return true;
            }

            if (b[0] == 0x3F && b[1] == 0xF0 && b[2] == 0 && b[3] == 0 && b[4] == 0 && b[5] == 0 && b[6] == 0 && b[7] == 0)
            {
                return false;
            }
        ...
        public static unsafe UInt128 ToUInt128(byte[] value, int index = 0)
        {
            ...
            fixed (byte* ptr = &value[index])
            {
                return new UInt128(*(ulong*)(ptr + 8), *(ulong*)ptr);
            }
        }
        ...
        public static byte[] GetBytes(bool[] value, int index = 0, int count = 0)
        {
            ...
            {
                throw new ArgumentOutOfRangeException("count", "Must be less than or equal to the length of value minus the index argument.");
            }
        ...
        public static bool[] ToBooleanArray(byte[] value, int index = 0, int count = 0)
        {
            ...
            if (index + count > value.Length)
            {
                throw new ArgumentOutOfRangeException("count", "Must be less than or equal to the length of the byte array minus the index argument.");
            }
        ...
        public static unsafe char[] ToCharArray(byte[] value, int index = 0, int count = 0)
        {
            ...
            if (index + count * 2 > value.Length)
            {
                throw new ArgumentOutOfRangeException("count", "Must be less than or equal to the length of the byte array minus the offset argument divided by 2.");
            }

            if (count == 0)
            {
                count = (value.Length - index) / 2;
            }
        ...
        public static unsafe int[] ToInt32Array(byte[] value, int index = 0, int count = 0)
        {
            ...
            if (index + count * 4 > value.Length)
            {
                throw new ArgumentOutOfRangeException("count", "Must be less than or equal to the length of the byte array minus the offset argument divided by 4.");
            }

            if (count == 0)
            {
                count = (value.Length - index) / 4;
            }
        ...
        public static unsafe long[] ToInt64Array(byte[] value, int index = 0, int count = 0)
        {
            ...
            if (index + count * 8 > value.Length)
            {
                throw new ArgumentOutOfRangeException("count", "Must be less than or equal to the length of the byte array minus the offset argument divided by 8.");
            }

            if (count == 0)
            {
                count = (value.Length - index) / 8;
            }
        ...
        public static unsafe UInt128[] ToUInt128Array(byte[] value, int index = 0, int count = 0)
        {
            ...
            if (index + count * 16 > value.Length)
            {
                throw new ArgumentOutOfRangeException("count", "Must be less than or equal to the length of the byte array minus the offset argument divided by 16.");
            }

            if (count == 0)
            {
                count = (value.Length - index) / 16;
            }
            ...
            fixed (byte* ptr = &value[index])
            {
                for (int i = 0; i < count; i++)
                {
                    ret[i] = new UInt128(*((ulong*)ptr + 2 * i + 1), *((ulong*)ptr + 2 * i));
                }
            }
        ...
        public static char[] ToCharArraySwapped(byte[] value, int index = 0, int count = 0)
        {
            ...
            {
                ret[i] = (char)(value[index] << 8 | value[index + 1]);
            }
        ...
        public static short[] ToInt16ArraySwapped(byte[] value, int index = 0, int count = 0)
        {
            ...
            for (int i = 0; i < count; i++, index += 2)
            {
                ret[i] = (short)(value[index] << 8 | value[index + 1]);
            }
        ...
        public static ushort[] ToUInt16ArraySwapped(byte[] value, int index = 0, int count = 0)
        {
            ...
            for (int i = 0; i < count; i++, index += 2)
            {
                ret[i] = (ushort)(value[index] << 8 | value[index + 1]);
            }
        ...
        public static int[] ToInt32ArraySwapped(byte[] value, int index = 0, int count = 0)
        {
            ...
            {
                ret[i] = value[index] << 24 | value[index + 1] << 16 | value[index + 2] << 8 | value[index + 3];
            }
        ...
        public static uint[] ToUInt32ArraySwapped(byte[] value, int index = 0, int count = 0)
        {
            ...
            for (int i = 0; i < count; i++, index += 4)
            {
                ret[i] = (uint)(value[index] << 24 | value[index + 1] << 16 | value[index + 2] << 8 | value[index + 3]);
            }
        ...
        public static string ToString(byte[] value, int index, int length)
        {
            ...
            if (length == 0/*&&index==0&&value.Length==0*/)
            {
                return string.Empty;
            }
        ...
        {
            if (!IsLittleEndian ^ IsDoubleLittleEndian)
            {
                return *(long*)&value;
            }
