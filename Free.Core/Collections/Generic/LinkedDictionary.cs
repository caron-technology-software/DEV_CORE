    ...
    public class LinkedDictionary<TKey, TValue> : IDictionary<TKey, TValue>, IReadOnlyDictionary<TKey, TValue>, IDictionary, IElementLookup<TKey, TValue>
    {
        ...
        public TValue this[TKey key]
        {
            ...
            set
            {
                ...
                {
                    dict[key].Value = new Tuple<TKey, TValue>(key, value);
                }
            }
        }
        ...
        bool ICollection<KeyValuePair<TKey, TValue>>.Contains(KeyValuePair<TKey, TValue> item)
        {
            ...
            {
                return EqualityComparer<TValue>.Default.Equals(node.Value.Item2, item.Value);
            }
        ...
        void ICollection<KeyValuePair<TKey, TValue>>.CopyTo(KeyValuePair<TKey, TValue>[] array, int arrayIndex)
        {
            ...
            {
                throw new ArgumentException(ExpectionMessageArrayPlusOffsetTooSmall, nameof(array));
            }

            int offset = arrayIndex;
            foreach (var keyValue in list)
            {
                array[offset++] = new KeyValuePair<TKey, TValue>(keyValue.Item1, keyValue.Item2);
            }
        }
        ...
        void ICollection.CopyTo(Array array, int arrayIndex)
        {
            ...
            if (array.Rank != 1)
            {
                throw new ArgumentException(ExpectionMessageArrayRankNotOne, nameof(array));
            }

            if (array.GetLowerBound(0) != 0)
            {
                throw new ArgumentException(ExpectionMessageArrayLowerBoundNotZero, nameof(array));
            }
            ...
            try
            {
                foreach (var keyValue in list)
                {
                    objects[offset++] = new KeyValuePair<TKey, TValue>(keyValue.Item1, keyValue.Item2);
                }
            }
        ...
        public KeyValuePair<TKey, TValue> First()
        {
            ...
            if (first == null)
            {
                throw new InvalidOperationException(ExpectionMessageCollectionIsEmpty);
            }
        ...
        sealed class KeyCollection : ICollection<TKey>, ICollection, IReadOnlyCollection<TKey>
        {
            ...
            {
                if (linkedDictionary == null)
                {
                    throw new ArgumentNullException(nameof(linkedDictionary));
                }
            ...
            void ICollection<TKey>.CopyTo(TKey[] array, int arrayIndex)
            {
                ...
                if (array.Length - arrayIndex < linkedDictionary.Count)
                {
                    throw new ArgumentException(ExpectionMessageArrayPlusOffsetTooSmall, nameof(array));
                }
            ...
            IEnumerator<TKey> IEnumerable<TKey>.GetEnumerator() { foreach (var keyValue in linkedDictionary.list)
                {
                    yield return keyValue.Item1;
                }
            }

            IEnumerator IEnumerable.GetEnumerator() { foreach (var keyValue in linkedDictionary.list)
                {
                    yield return keyValue.Item1;
                }
            }
        ...
        sealed class ValueCollection : ICollection<TValue>, ICollection, IReadOnlyCollection<TValue>
        {
            ...
            bool ICollection<TValue>.Contains(TValue item)
            {
                ...
                else
                {
                    ...
                    foreach (var keyValue in linkedDictionary.list)
                    {
                        if (c.Equals(keyValue.Item2, item))
                        {
                            return true;
                        }
                    }
            ...
            IEnumerator<TValue> IEnumerable<TValue>.GetEnumerator() { foreach (var keyValue in linkedDictionary.list)
                {
                    yield return keyValue.Item2;
                }
            }
