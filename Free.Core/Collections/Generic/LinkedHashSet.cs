...
namespace Free.Core.Collections.Generic
{
    ...
    public class LinkedHashSet<T> : ISet<T>, IElementLookup<T, T>
    {
        ...
        public void UnionWith(IEnumerable<T> other)
        {
            ...
            {
                return; // We union with ourself, so no element will added.
            }
        ...
        public void IntersectWith(IEnumerable<T> other)
        {
            ...
            if (ReferenceEquals(this, other))
            {
                return; // We intersect with ourself, so all elements will stay.
            }
        ...
        public bool IsSubsetOf(IEnumerable<T> other)
        {
            ...
            if (dict.Count == 0 || ReferenceEquals(this, other))
            {
                return true;
            }
            ...
            if (collection != null)
            {
                ...
                if (dict.Count > collection.Count)
                {
                    return false;
                }
        ...
        public bool IsProperSubsetOf(IEnumerable<T> other)
        {
            ...
            if (ReferenceEquals(this, other))
            {
                return false; // Set can not be a proper subset of itself.
            }
        ...
        public bool SetEquals(IEnumerable<T> other)
        {
            ...
            if (collection != null)
            {
                ...
                if (dict.Count == 0 && collection.Count > 0)
                {
                    return false;
                }
