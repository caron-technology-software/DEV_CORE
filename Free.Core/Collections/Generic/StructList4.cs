    ...
    public struct StructList4<T> : IList<T>, IReadOnlyList<T>, IEquatable<StructList4<T>>
    {
        ...
        public T this[int index]
        {
            get
            {
                ...
                {
                    throw new ArgumentOutOfRangeException(nameof(index), MustBePositiveAndSmallerNumberOfElementsExceptionMessage);
                }
        ...
        public void CopyTo(T[] array, int arrayIndex = 0)
        {
            ...
            {
                throw new ArgumentOutOfRangeException(nameof(arrayIndex), MustBePositiveAndSmallerTargetSizeExceptionMessage);
            }

            if (count > array.Length - arrayIndex)
            {
                throw new ArgumentException(MustHaveSpaceToHoldContentIndexExceptionMessage, nameof(array));
            }
        ...
        public bool Equals(StructList4<T> other)
        {
            ...
            if (!Equals(v0, other.v0))
            {
                return false;
            }

            if (!Equals(v1, other.v1))
            {
                return false;
            }

            if (!Equals(v2, other.v2))
            {
                return false;
            }

            if (!Equals(v3, other.v3))
            {
                return false;
            }
        ...
        {
            if (index < 0 || index >= Math.Min(1, count))
            {
                throw new ArgumentOutOfRangeException(nameof(index), MustBePositiveAndSmallerNumberOfElementsExceptionMessage);
            }
        ...
        {
            if (index < 0 || index >= Math.Min(1, this.count))
            {
                throw new ArgumentOutOfRangeException(nameof(index), MustBePositiveAndSmallerNumberOfElementsExceptionMessage);
            }
            ...
            {
                throw new ArgumentOutOfRangeException(nameof(count), MustBePositiveAndMustNotExceedNumberOfElementsLeftExceptionMessage);
            }
        ...
        public void Insert(int index, T item)
        {
            if (index < 0 || index > count)
            {
                throw new ArgumentOutOfRangeException(nameof(index), MustBePositiveAndSmallerOrEqualNumberOfElementsExceptionMessage);
            }
        ...
        IEnumerator<T> GetEnumerator()
        {
            ...
            if (ver != version)
            {
                throw new InvalidOperationException(EnumerationFailedExceptionMessage);
            }
