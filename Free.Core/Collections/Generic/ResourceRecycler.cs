...
namespace Free.Core.Collections.Generic
{
    ...
    public class ResourceRecycler<K, T> where K : class
    {
        ...
        public void Init(T[] resources)
        {
            ...
            {
                throw new ArgumentException("Must not be empty.", nameof(resources));
            }
        ...
        public bool MoveToTop(K key)
        {
            ...
            {
                Tail = entry.Previous; // Don't forget to update Tail when entry is the tail.
            }
        ...
        public T RecycleToTop(K newKey)
        {
            ...
            {
                throw new InvalidOperationException("Cache is empty. Recycling not possible.");
            }
