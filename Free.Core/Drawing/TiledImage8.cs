...
namespace Free.Core.Drawing
{
    ...
    public class TiledImage8 : TiledImage
    {
        ...
        public void Clear(int color = 0)
        {
            switch (NumberOfChannels)
            {
                ...
                case 3:
                    if (PlanarConfiguration == PlanarConfiguration.Continuously)
                    {
                        InitContinuousImageRGB((byte)(color >> 16), (byte)(color >> 8), (byte)color);
                    }
                    else
                    {
                        InitSeperatedImageRGB((byte)(color >> 16), (byte)(color >> 8), (byte)color);
                    }
                ...
                case 4:
                    if (PlanarConfiguration == PlanarConfiguration.Continuously)
                    {
                        InitContinuousImageRGBX((byte)(color >> 16), (byte)(color >> 8), (byte)color, (byte)(color >> 24));
                    }
                    else
                    {
                        InitSeperatedImageRGBX((byte)(color >> 16), (byte)(color >> 8), (byte)color, (byte)(color >> 24));
                    }
        ...
        public virtual TiledImage8 ExtraChannelRemoved()
        {
            ...
            if (this is Image8)
            {
                ret = new Image8(Width, Height, true, false, true, PlanarConfiguration);
            }
            else if (this is ChunkedImage8)
            {
                ret = new ChunkedImage8(Width, Height, true, false, true, ((ChunkedImage8)this).ChunkHeight, PlanarConfiguration);
            }
            else
            {
                ret = new TiledImage8(Width, Height, true, false, true, TileWidth, TileHeight, PlanarConfiguration);
            }
        ...
        public TiledImage8 GetSubImage(int x, int y, int width, int height)
        {
            ...
            if (this is Image8)
            {
                ret = new Image8(width, height, NumberOfChannels >= 3, NumberOfChannels > 3, true, PlanarConfiguration);
            }
            else if (this is ChunkedImage8)
            {
                ret = new ChunkedImage8(width, height, NumberOfChannels >= 3, NumberOfChannels > 3, true, ((ChunkedImage8)this).ChunkHeight, PlanarConfiguration);
            }
            else
            {
                ret = new TiledImage8(width, height, NumberOfChannels >= 3, NumberOfChannels > 3, true, TileWidth, TileHeight, PlanarConfiguration);
            }
        ...
        public Image8 GetTile(int x, int y, int channel)
        {
            ...
            {
                Buffer.BlockCopy(Bits[(y * NumberOfTileX + x) * NumberOfChannels + channel], 0, ret.Bits[0], 0, tileSize);
            }
