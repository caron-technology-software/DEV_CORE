...
namespace Free.Core.Drawing
{
    ...
    public class TiledFloatImage : TiledImage
    {
        ...
        public virtual TiledFloatImage ExtraChannelRemoved()
        {
            ...
            if (this is FloatImage)
            {
                ret = new FloatImage(Width, Height, true, false, true, PlanarConfiguration);
            }
            else if (this is ChunkedFloatImage)
            {
                ret = new ChunkedFloatImage(Width, Height, true, false, true, ((ChunkedFloatImage)this).ChunkHeight, PlanarConfiguration);
            }
            else
            {
                ret = new TiledFloatImage(Width, Height, true, false, true, TileWidth, TileHeight, PlanarConfiguration);
            }
        ...
        public TiledFloatImage GetSubImage(int x, int y, int width, int height)
        {
            ...
            if (this is FloatImage)
            {
                ret = new FloatImage(width, height, NumberOfChannels >= 3, NumberOfChannels > 3, true, PlanarConfiguration);
            }
            else if (this is ChunkedFloatImage)
            {
                ret = new ChunkedFloatImage(width, height, NumberOfChannels >= 3, NumberOfChannels > 3, true, ((ChunkedFloatImage)this).ChunkHeight, PlanarConfiguration);
            }
            else
            {
                ret = new TiledFloatImage(width, height, NumberOfChannels >= 3, NumberOfChannels > 3, true, TileWidth, TileHeight, PlanarConfiguration);
            }
        ...
        public FloatImage GetTile(int x, int y, int channel)
        {
            ...
            {
                Buffer.BlockCopy(Bits[(y * NumberOfTileX + x) * NumberOfChannels + channel], 0, ret.Bits[0], 0, tileSize * sizeof(float));
            }
