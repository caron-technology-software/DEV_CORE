...
{
    public partial class MachineNumericEditableItem : MachineEditableItem
    {
        //GPIx258
        ...
        public int PropertyValue
        {
            ...
            set
            {
                if ((MaxValue != null) && (MinValue != null))
                {
                    if (value > MaxValue)
                    {
                        propertyValue = (int)MaxValue;
                    }
                    else if (value < MinValue)
                    {
                        propertyValue = (int)MinValue;
                    }
                    else
                    {
                        propertyValue = value;
        ...
        public MachineNumericEditableItem()
        {
            InitializeComponent();
